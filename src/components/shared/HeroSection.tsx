      ...
      <div className="container relative z-10 mx-auto px-4 flex flex-col items-center text-center gap-10">
        <div className="space-y-6 max-w-4xl pt-4">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-extrabold tracking-tight text-foreground leading-tight">
            Sua beleza e estilo <br className="hidden md:block" /> em um só lugar.
          </h1>
          <p className="text-lg md:text-xl text-muted-foreground/90 max-w-3xl mx-auto font-medium shadow-black drop-shadow-md flex flex-wrap justify-center items-center gap-x-1.5">
            <span>A plataforma premium para agendar horários em</span>
            <span className="font-semibold"><RotatingSegmentWord /></span>
            <span>da sua região.</span>
          </p>
        </div>
