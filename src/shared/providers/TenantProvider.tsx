...
import { useMyTenants } from "@/shared/hooks/useMyTenants";
import { Membership, TenantUserRole } from "@/shared/lib/api/types";
...
export function TenantProvider({ children }: { children: React.ReactNode }) {
  ...
  const { data, isPending, isFetching, isError, refetch } = useMyTenants();
