      ...
      <div className="container mx-auto px-4 max-w-5xl">
        ...
        <section className="flex flex-col md:flex-row gap-6 items-start md:items-center justify-between mb-10">
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <p className="text-zinc-500">Seu resumo diário para hoje.</p>
            </div>
          </div>
        </section>
        ...
        <section className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex flex-col">
            ...
            <span className="text-xs text-zinc-500 uppercase font-medium">Na Fila Hoje</span>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex flex-col">
            ...
            <span className="text-xs text-zinc-500 uppercase font-medium">Concluídos Hoje</span>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex flex-col">
            ...
            <span className="text-xs text-zinc-500 uppercase font-medium">Cortes Totais</span>
          </div>
          <div className="bg-zinc-900 border border-zinc-800 rounded-2xl p-4 flex flex-col">
            ...
            <span className="text-xs text-zinc-500 uppercase font-medium">Avaliações 5 Estrelas</span>
          </div>
        </section>
        ...
        <section>
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-bold text-white">Agenda Ativa</h2>
