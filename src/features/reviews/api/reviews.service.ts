...
import { Review, ReviewComment, ReviewList } from "@/shared/lib/api/types";
import type {
  CreateReviewDto,
  ReplyReviewDto,
  CreateReviewCommentDto,
} from "@/features/reviews/api/dto/reviews.dto";

export type { CreateReviewDto, ReplyReviewDto, CreateReviewCommentDto };
