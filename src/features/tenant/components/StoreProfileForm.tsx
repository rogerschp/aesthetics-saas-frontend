...
import { maskCep, maskCnpj, maskPhoneBR } from "@/shared/lib/masks";
import { MediaImageField } from "@/shared/components/MediaImageField";
import { MediaType } from "@/shared/lib/api/types";
import { tenantsService } from "@/features/tenant/api/tenants.service";
import { TENANT_SEGMENT_OPTIONS } from "@/shared/lib/tenant-segments";
          ...
          <div className="grid grid-cols-1 gap-6 border-t border-zinc-800/50 pt-4 md:grid-cols-2">
            <MediaImageField
              ...
              onLink={async (media) => {
                ...
                await queryClient.invalidateQueries({
                  queryKey: sessionKeys.tenantsAll,
                });
              }}
              onChange={(url) =>
