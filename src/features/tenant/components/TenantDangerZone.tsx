...
export function TenantDangerZone({
  ...
  const statusMutation = useUpdateTenantStatus(tenantId, {
    onSuccess: () => {
      setError(null);
      onStatusChange?.();
    },
