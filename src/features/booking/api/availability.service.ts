...
import { DayOfWeek, WorkingHours, AvailableSlotsResponse } from "@/features/booking/model/availability.types";
import type { BootstrapWorkingWeekDto } from "@/features/booking/api/dto/availability.dto";

export type { BootstrapWorkingWeekDto };
