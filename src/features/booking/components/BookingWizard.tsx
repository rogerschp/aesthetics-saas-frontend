...
import { cn, formatPriceBRL } from "@/shared/lib/utils";
...
import { formatApiError, parseApiError } from "@/shared/lib/api/errors";
...
export function BookingWizard({
  ...
  const draftMutation = useCreateBookingDraft(isLogged, {
    onSuccess: (booking) => {
      setResult(booking);
      setError(null);
      setStep("done");
                  ...
                  <Button
                    ...
                    onClick={() =>
                      draftMutation.mutate({
                        ...
                        date,
                        startTime: slot!,
                        guest: !isLogged ? guest : undefined,
                      })
                    }
                  >
